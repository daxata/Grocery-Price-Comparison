...
url_sastodeal = 'https://www.sastodeal.com/sd-fast/food-essentials/sugar-salt-masalas-spices.html'
url_thulo = 'https://thulo.com/spices-masalas-and-salt/'
...
# sql = ("INSERT INTO spice(name, price, url, image) VALUES (%s, %s, %s, %s)")
