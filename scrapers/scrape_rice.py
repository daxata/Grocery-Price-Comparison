...
url_sastodeal = 'https://www.sastodeal.com/sd-fast/food-essentials/rice-rice-products.html'
url_thulo = 'https://thulo.com/rice-and-rice-products/'
...
sql = ("INSERT INTO rice(name, price, url, image) VALUES (%s, %s, %s, %s)")
