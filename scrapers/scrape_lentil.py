...
url_sastodeal = 'https://www.sastodeal.com/sd-fast/food-essentials/beans-lentils-products.html'
url_thulo = 'https://thulo.com/daal-pulses-and-lentils/'
...
# sql = ("INSERT INTO lentil(name, price, url, image) VALUES (%s, %s, %s, %s)")
