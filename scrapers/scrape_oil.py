...
url_sastodeal = 'https://www.sastodeal.com/sd-fast/food-essentials/cooking-oils-vinegar.html'
url_thulo = 'https://thulo.com/cooking-oil-and-ghee/'
...
#sql = ("INSERT INTO oil(name, price, url, image) VALUES (%s, %s, %s, %s)")
